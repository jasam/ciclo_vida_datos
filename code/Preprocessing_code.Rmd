...
```{r}
goal_usd_us = ks_df[country == "US"]$usd_goal_real
goal_usd_gb = ks_df[country == "GB"]$usd_goal_real
```
...
```{r}
r = cor(ks_df[, c("backers","usd_pledged_real", "usd_goal_real", "diff_pledge_real")], 
        use="complete.obs")
...
## ¿La meta recolectada es diferente entre los dos paises: US y GB?
